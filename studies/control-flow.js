...
// 2. Else Statement // The else statement runs a code block if all other previous conditional stateemtn are not truthy.
...
// 3. Else-If Statement // The else-if statement tests if another condtion evaluates truthy.
...
// 4. Switch Statement // The swithch statement tests to see if an expression meets any of the cases within the switch statement.
